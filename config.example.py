...
APP_TOKEN: str = os.environ.get('APP_TOKEN', 'your_discord_bot_token_here')
APP_OWNER_ID: int = int(os.environ.get('APP_OWNER_ID', '123456789'))

MONGO_URI: str = os.environ.get('MONGO_URI', 'mongodb://localhost:27017/dynohunt')

START_TIME_TIMESTAMP: int = 1735689600  # Example timestamp
END_TIME_TIMESTAMP: int = 1736294400   # Example timestamp

EVENTS_CHANNEL_ID: int = 123456789012345678
# Logs channel can be a text channel ID or a thread ID
LOGS_CHANNEL_ID: int = 123456789012345679

COUNCIL_ROLE: int = 123456789012345680
COMM_WIZARD_ROLE: int = 123456789012345681
HUNT_CHAMPION_ROLE: int = 123456789012345682
